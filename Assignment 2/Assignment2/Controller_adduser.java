...
public class Controller_adduser {
        ...
        if (employee_name.equals("") | employee_type == null){
            ...
            if (employee_type.equals("Faculty")) {
                ...
                if (employee_department == null) {
                    ...
                    ctrl.listview_employee.setItems(Assignment2.class_variables.employeeList);
    ...
    @FXML private void initialize() {
        ...
        int length = 6 - String.valueOf(Assignment2.class_variables.employee_id_counter+1).length();
        String filler = "";
